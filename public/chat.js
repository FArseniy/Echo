...
function prepareForRejoin(message) { document.body.classList.remove('room-active'); hasJoinedRoom = false; needsRejoin = true; resumeInFlight = false; selfParticipantId = null; currentRoom = null; isCurrentOwner = false; e2ee = null; closeAllPeers(); typingUsers.clear(); renderTyping(); clearTimeout(typingTimer); isTyping = false; messageInput.disabled = true; messageButton.disabled = true; ownerControls.hidden = true; roomLayout.hidden = true; joinPanel.hidden = false; joinError.textContent = message; pinInput.value = ''; }
